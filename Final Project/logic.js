...
for (var i = 0; i < sites.length; i++) {
  ...
  L.marker(city.location)
    .bindPopup("<h4><b>" + city.Ride + "</h4> </b> <h6> Average Wait Time (mins): " + city.AvgWait + "</h6> <b> <h6> Maximum Wait Time (mins): " + city.MaxWait +"</h6><b><h6> Minimum Wait Time (mins): " + city.MinWait + "</h6><b><h6>Ride Description: " + city.info + "</h6>")
    .addTo(myMap);
}
